...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-neutral text-neutral-content">
            <aside>
                <BiSolidDonateBlood className="text-7xl text-red-600"/>
                <p className="text-lg font-bold">Blood Donation Management<br /><span className="text-base font-normal">Donate blood, Save lives.</span></p>
            </aside>
            <nav>
